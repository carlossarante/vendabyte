...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Article.is_date_expired'
        db.add_column(u'articles_article', 'is_date_expired',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Article.is_date_expired'
        db.delete_column(u'articles_article', 'is_date_expired')
