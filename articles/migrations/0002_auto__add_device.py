...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Device'
        db.create_table(u'articles_device', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('device_detail', self.gf('django.db.models.fields.CharField')(max_length=30)),
        ))
        db.send_create_signal(u'articles', ['Device'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'articles_device')
    ...
    models = {
        ...
        u'articles.device': {
            ...
            'brands': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['articles.Brand']", 'symmetrical': 'False'}),
