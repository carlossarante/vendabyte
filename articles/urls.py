...
urlpatterns = patterns('',
    url(r'^my/interesting/$', 'articles.views.getInterestingArticles'),
    ...
    url(r'^list/new/$', 'articles.views.getNewUploadedArticles'),
    url(r'^list/popular/$', 'articles.views.getMostPopularArticles'),
